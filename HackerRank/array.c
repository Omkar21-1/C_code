...
int main()
{
    ...
    for (int i = 0; i < total_number_of_shelves; i++) {
        total_number_of_books[i] = 0; // Initialize total number of books on each shelf to 0

        // Initialize total_number_of_pages for each shelf
        total_number_of_pages[i] = (int*)malloc(1000 * sizeof(int)); // Assuming a maximum of 1000 books per shelf
    }
