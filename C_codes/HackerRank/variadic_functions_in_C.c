/*
	...
	In this problem, you will implement three variadic functions named "sum(),min() and max()"  and  to calculate sums, minima, maxima of a variable number of arguments. 
	The first argument passed to the variadic function is the count of the number of
	arguments, which is followed by the arguments themselves.
