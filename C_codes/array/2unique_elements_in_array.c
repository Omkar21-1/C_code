...
void count_unique_elements_of_array(int [],int,int [],int);
void disp(int [],int);
...
void count_unique_elements_of_array(int a[],int n,int count[],int max)
{
	int check=0;
...
int main()
{
	...
	//COUNTING UNIQUE ELEMENTS OF ARRAY......
	count_unique_elements_of_array(a,n,count,max);
